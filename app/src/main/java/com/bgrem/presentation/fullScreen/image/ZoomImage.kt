...
class ZoomImage: AppCompatImageView, View.OnTouchListener,
    ...
    // required Scales
    var presentScale = 1f
    var minimumScale = -100f
    var maximumScale = 100f
    ...
    fun fittedTranslation() {
        ...
        val fittedTransX = getFittedTranslation(
            translationX, mViewedWidth.toFloat(), originalWidth * presentScale)
        val fittedTransY = getFittedTranslation(
            translationY, mViewedHeight.toFloat(), originalHeight * presentScale)
        ...
        when (mMouseEvent.action) {
            ...
            MotionEvent.ACTION_MOVE -> if (zoomMode == 1) {
                ...
                val fixedTranslationX = getFixDragTrans(
                    changeInX, mViewedWidth.toFloat(), originalWidth * presentScale)
                val fixedTranslationY = getFixDragTrans(
                    changeInY, mViewedHeight.toFloat(), originalHeight * presentScale)

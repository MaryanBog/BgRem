    ...
    Column(
        ...
        Text(
            modifier = Modifier
                ...
                .fillMaxWidth(),
            text = stringResource(id = R.string.trouble_server_error),
            style = Typography.h2,
        ...
        Image(
            ...
            painter = painterResource(id = R.drawable.cm_error_500),
...
@Composable
fun TroubleServerScreenPreview() {
